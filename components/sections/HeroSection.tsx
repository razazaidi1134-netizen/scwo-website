          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-20 items-center">
            ...
            <div>
              ...
              <motion.p
                ...
                style={{ fontSize: 18, color: 'rgba(255,255,255,.75)', maxWidth: 520, marginBottom: 40, lineHeight: 1.65 }}
              >
              ...
              >
                {metaItems.map((item) => (
                  <div key={item.label}>
                    ...
                    <strong style={{ fontFamily: "'Fraunces', serif", fontWeight: 500, fontSize: 18 }}>
                      {item.value}
                    </strong>
                  </div>
                ))}
