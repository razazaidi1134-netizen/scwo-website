            ...
            <aside style={{ display: 'flex', flexDirection: 'column', gap: '1px' }}>
              ...
              <AnimatedSection delay={0.1}>
                <div style={{ background: '#fff', border: '1px solid var(--line)', borderBottom: 'none', borderRadius: '2px 2px 0 0', overflow: 'hidden' }}>
                  <div style={{ padding: '20px 28px', borderBottom: '1px solid var(--line)', background: 'var(--g9)' }}>
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--a4)' }}>Contact Details</span>
                  </div>
                  {contactDetails.map(({ num, label, lines, hrefs }) => (
                    <div key={label} style={{ display: 'flex', gap: '16px', padding: '20px 28px', borderBottom: '1px solid var(--line)', alignItems: 'flex-start' }}>
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', color: 'var(--a5)', flexShrink: 0, marginTop: '2px' }}>{num}</span>
                      <div>
                        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--soft)', marginBottom: '6px' }}>{label}</div>
                        {lines.map((line, i) =>
                          hrefs ? (
              ...
              <AnimatedSection delay={0.15}>
                <div style={{ background: '#fff', border: '1px solid var(--line)', borderBottom: 'none' }}>
                  <div style={{ padding: '20px 28px', borderBottom: '1px solid var(--line)', background: 'var(--paper)' }}>
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--g8)' }}>Office Hours</span>
                  </div>
                  {hours.map(({ day, time }) => (
                    <div key={day} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 28px', borderBottom: '1px solid var(--line)' }}>
                      ...
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '11px', color: time === 'Closed' ? 'rgba(74,74,74,.4)' : 'var(--g8)', letterSpacing: '0.05em' }}>{time}</span>
                    </div>
                  ))}
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={0.2}>
                <div id="donate" style={{ background: 'var(--a5)', padding: '32px 28px' }}>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--g8)', marginBottom: '12px', opacity: 0.7 }}>Support Our Mission</div>
                  <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: '24px', fontWeight: 400, color: 'var(--g9)', marginBottom: '12px', lineHeight: 1.2 }}>
              ...
              <AnimatedSection delay={0.25}>
                <div style={{ background: 'var(--g9)', color: '#fff', padding: '32px 28px', borderRadius: '0 0 2px 2px' }}>
                  <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: '10px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--a4)', marginBottom: '12px' }}>Get Involved</div>
                  <h3 style={{ fontFamily: "'Fraunces', serif", fontSize: '22px', fontWeight: 400, color: '#fff', marginBottom: '10px', lineHeight: 1.2 }}>
